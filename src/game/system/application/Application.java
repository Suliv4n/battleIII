...
public class Application{
	 ...
	 * En cr�e une si elle n'existe pas.
	 * 
	...
	/**
	 * Teste si l'application est en plein �cran.
	 * 
	 * @return vrai si l'application est en plein �cran, sinon 
	 * retourne faux.
	 */
	...
	/**
	 * Passe du mode plein �cran au mode fen�tr� en inversement.
	 * 
	 * @throws SlickException
	 */
	...
	/**
	 * Charge un particle system avec l'emmiter et l'image pass� en param�tre.
	 * 
	 * @param emmiter
	 * 		Fichier emmiter sans l'extension xml (depuis le dossier particles).
	 * @param image
	 * 		Image depuis le dossier des images.
	 * @return le particle system avec l'emmiter et l'image pass� en param�tre.
	 */
	...
	/**
	 * Dessine la chaine de caract�res pass� en param�tre
	 * avec la police par d�faut de slick. 
	 * 
	 * @param string
	 * 		Chaine de caract�res � afficher.
	 * @param x
	 * 		Abscisse o� afficher la cha�ne.
	 * @param y
	 * 		Ordonn�e o� afficher la cha�ne.
	 */
	...
	/**
	 * Dessine la chaine de caract�res pass� en param�tre. Avec la couleur
	 * pass� en param�re.
	 * 
	 * @param string
	 * 		Chaine de caract�res � afficher.
