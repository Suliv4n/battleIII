...
public class Party implements Iterable<Character>
{
	...
	//COORDONNEES
	private double relativeX; // par rapport Ã  l'écran
	...
	/**
	 * Retourne le sac de l'équipe oÃ¹ se trouve les objets 
	 * de l'équipe.
	 * 
	...
	/**
	 * Met Ã  jour la position relative (coordonnées par rapport Ã  la fenêtre) sur l'axe X de l'équipe.
	 * 
	 * @param dx
	...
	/**
	 * Met Ã  jour la position relative (coordonnées par rapport Ã  la fenêtre) sur l'aye Y de l'équipe.
	 * 
	 * @param dy
	...
	/**
	 * Retourne la position relative (par rapport Ã  la fenetre) de l'équipe sur l'axe X.
	 * 
	 * @return la position relative (par rapport Ã  la fenetre) de l'équipe sur l'axe X.
	 */
	...
	/**
	 * Retourne la position relative (par rapport Ã  la fenetre) de l'équipe sur l'axe Y.
	 * 
	 * @return la position relative (par rapport Ã  la fenetre) de l'équipe sur l'axe Y.
	 */
	...
	/**
	 * Retourne la position absolue (par rapport Ã  la map) de l'équipe sur l'axe X.
	 * 
	 * @return la position absolue (par rapport Ã  la map) de l'équipe sur l'axe X.
	 */
	...
	/**
	 * Met Ã  jour la position absolue (coordonnées par rapport Ã  la map) sur l'aye X de l'équipe.
	 * 
	 * @param dx
	...
	/**
	 * Retourne la position absolue (par rapport Ã  la map) de l'équipe sur l'axe Y.
	 * 
	 * @return la position absolue (par rapport Ã  la map) de l'équipe sur l'axe Y.
	 */	
	...
	/**
	 * Met Ã  jour la position absolue (coordonnées par rapport Ã  la map) sur l'aye Y de l'équipe.
	 * 
	 * @param dy
	...
	/**
	 * Retourne le personnage Ã  la position passé en paramÃ¨tre.
	 * 
	 * @param i
	 * 		Index du personnage Ã  retourner.
	 * @return
	 * 		le personnage de l'équipe Ã  l'index i.
	 */
	...
	/**
	 * Retourne le personnage Ã  l'index passé en paramÃ¨tre ou retourne
	...
	/**
	 * Modifie l'ordonnée relative de l'équipe (par raport Ã  l'écran).
	 * 
	 * @param y
	...
	/**
	 * Modifie l'abscisse relative de l'équipe (par raport Ã  l'écran).
	 * 
	 * @param x
	...
	/**
	 * Retourne l'index du personnage passé en paramÃ¨tre ou -1 si le personnage n'est pas dans l'équipe.
	 * @param personnage
	 * 		Personnage dont l'index est Ã  retourner.
	 * @return
	 * 		l'index du personnage passé en paramÃ¨tre ou -1 si le personnage n'est pas dans l'équipe.
	 */
	...
	/**
	 * Retourne vrai si l'équipe a déjÃ  analysé l'ennemi dont l'id est passé en paramÃ¨tre, sinon faux.
	 * @param id
	 * 		L'id de l'ennemi.
	 * @return
	 * 		 vrai si l'équipe a déjÃ  analysé l'ennemi dont l'id est passé en paramÃ¨tre, sinon faux.
	 */
	...
	/**
	 * Retourne vrai si l'equipable passé en paramÃ¨tre est équipé
	 * par l'un des personnage de l'équipe, sinon faux.
	 * 
	 * @param equipable
	 * 		Stuff Ã  tester
	 * 
	 * @return vrai si l'equipable passé en paramÃ¨tre est équipé
	 * par l'un des personnage de l'équipe, sinon faux.
	 */
	...
	/**
	 * Ajoute un objet en quantité passé en paramÃ¨tre dans le sac de l'équipe.
	 * 
	 * @param item
	 * 		Objet Ã  ajouter.
	 * @param quantity
	 * 		Quantité de l'objet Ã  ajouter.
	 */
	...
	/**
	 * Ajoute un ennemi Ã  la liste des ennemis analysés.
	...
	/**
	 * CHange la map oÃ¹ se trouve l'équipe.
	 * 
	 * @param map
	 * 		Nouvelle map oÃ¹ se trouve l'équipe.
	 */
	...
	/**
	 * Modifie l'absisse absolue de l'équipe. (par rapport Ã  la map)
	 * 
	 * @param x
	...
	/**
	 * Modifie l'ordonnée absolue de l'équipe. (par rapport Ã  la map)
	 * 
	 * @param x
	...
	/**
	 * Met Ã  jour la monaie de l'équipe en ajoutant la valeur passé en paramÃ¨tre.
	 * @param money
	 * 		Valeur Ã  ajouter Ã  la monaie de l'équipe.
	 */
